...
export const metadata: Metadata = {
  ...
  description:
    "Water quality testing paired with amphibious deployments so The Water Raptor keeps clarity goals on track.",
  ...
  return (
    <div className="min-h-screen bg-transparent text-white">
      <section className="mx-auto max-w-5xl px-6 py-16 text-center space-y-6">
        ...
        <h1 className="text-4xl font-bold md:text-5xl">Water Quality Testing & Response</h1>
      ...
      <section className="mx-auto max-w-6xl px-6 py-10 grid gap-10 lg:grid-cols-[1.1fr_0.9fr]">
        <div className="space-y-6">
          <h2 className="text-3xl font-semibold">Collect data, then deploy</h2>
          <p className="text-slate-300">
      ...
      <section className="mx-auto max-w-4xl px-6 py-16">
        <div className="space-y-3 text-center">
          <h2 className="text-3xl font-bold">Ready to translate data into action?</h2>
          <p className="text-slate-300">
