...
export const metadata: Metadata = {
  ...
  description:
    "Learn how low-phosphorus fish food cuts nutrient loading while The Water Raptor keeps ponds clear during feed cycles.",
  ...
  return (
    <div className="min-h-screen bg-transparent text-white">
      <section className="mx-auto max-w-5xl px-6 py-16 space-y-6 text-center">
        ...
        <h1 className="text-4xl font-bold md:text-5xl">Optimal Low-Phosphorus Fish Food</h1>
      ...
      <section className="mx-auto max-w-6xl px-6 py-10">
        <div className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr] items-center">
          <div className="space-y-6">
            <h2 className="text-3xl font-semibold">Protect water quality during every feed</h2>
            <p className="text-slate-300">
      ...
      <section className="mx-auto max-w-6xl px-6 py-10">
        <div className="grid gap-6 md:grid-cols-3">
          {[
            ...
            <div key={item.title} className="rounded-2xl border border-white/10 bg-white/5 p-6 text-sm text-slate-200">
      ...
      <section className="mx-auto max-w-4xl px-6 py-16">
        <div className="space-y-3 text-center">
          <h2 className="text-3xl font-bold">Pair the right feed with targeted harvesting</h2>
          <p className="text-slate-300">
