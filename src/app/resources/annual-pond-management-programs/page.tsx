...
export const metadata: Metadata = {
  ...
  description:
    "Annual pond management programs keep clarity goals on track with The Water Raptor scheduled for harvest, maintenance, and dredging.",
  ...
  return (
    <div className="min-h-screen bg-transparent text-white">
      <section className="mx-auto max-w-5xl px-6 py-16 space-y-6 text-center">
        ...
        <h1 className="text-4xl font-bold md:text-5xl">Annual Pond Management Programs</h1>
      ...
      <section className="mx-auto max-w-6xl px-6 py-10">
        <div className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr] items-center">
          <div className="space-y-6">
            <h2 className="text-3xl font-semibold">Plan ahead for clarity</h2>
            <p className="text-slate-300">
      ...
      <section className="mx-auto max-w-4xl px-6 py-16">
        <div className="space-y-3 text-center">
          <h2 className="text-3xl font-bold">Ready to plan your year?</h2>
          <p className="text-slate-300">
